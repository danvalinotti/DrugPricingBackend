...
public interface ReportRowRepository extends JpaRepository<ReportRow,Integer> {
    ...
    @Query(value= "SELECT " +
            ...
            " FROM " +
            " (SELECT  drug_master.name,  drug_master.ndc, drug_master.gsn,drug_master.zip_code,  price.price, price.program_id, " +
            ...
            " WHERE report_id = ?1) t " +
            " GROUP BY t.name , t.dosage_strength, t.quantity, t.ndc, t.gsn, t.recommended_price, t.zip_code" +
